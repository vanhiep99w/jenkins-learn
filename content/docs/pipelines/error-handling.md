---
title: "Xử lý lỗi & Retry"
description: "Kiểm soát timeout, retry và trạng thái build."
---
...
> TODO: Bổ sung khái niệm, ví dụ và lưu ý thực tế cho **try/catch/finally**.

### 2. retry và timeout

> TODO: Bổ sung khái niệm, ví dụ và lưu ý thực tế cho **retry và timeout**.

### 3. catchError

> TODO: Bổ sung khái niệm, ví dụ và lưu ý thực tế cho **catchError**.

### 4. currentBuild.result

> TODO: Bổ sung khái niệm, ví dụ và lưu ý thực tế cho **currentBuild.result**.
