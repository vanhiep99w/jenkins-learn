...
description: "Chọn agent cho toàn Pipeline hoặc từng stage."
---
...
> TODO: Bổ sung khái niệm, ví dụ và lưu ý thực tế cho **agent any và none**.

### 2. label expression

> TODO: Bổ sung khái niệm, ví dụ và lưu ý thực tế cho **label expression**.

### 3. Docker agent

> TODO: Bổ sung khái niệm, ví dụ và lưu ý thực tế cho **Docker agent**.

### 4. Kubernetes agent

> TODO: Bổ sung khái niệm, ví dụ và lưu ý thực tế cho **Kubernetes agent**.
