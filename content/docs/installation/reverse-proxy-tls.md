...
description: "Đặt Jenkins sau Nginx, Apache hoặc load balancer."
---
...
> TODO: Bổ sung khái niệm, ví dụ và lưu ý thực tế cho **Context path**.

### 2. Forwarded headers

> TODO: Bổ sung khái niệm, ví dụ và lưu ý thực tế cho **Forwarded headers**.

### 3. TLS termination

> TODO: Bổ sung khái niệm, ví dụ và lưu ý thực tế cho **TLS termination**.

### 4. WebSocket cho agent

> TODO: Bổ sung khái niệm, ví dụ và lưu ý thực tế cho **WebSocket cho agent**.
